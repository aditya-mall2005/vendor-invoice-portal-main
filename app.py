...
st.write("• Forecast freight costs accurately")
st.write("• Detect risky or abnormal vendor invoices")
st.write("• Reduce financial leakage and manual workload")
col1, col2, col3 = st.columns([1,3,1])

#with col2:
#    st.image(
#       "images/invoice1.jpg", width=1200
#   )
...
st.markdown("---")
st.caption(
"Built by ADITYA MALL| Vendor Invoice Intelligence Portal | Streamlit + Machine Learning"
)           
